...
{
    return GetBoolArg("-testnet", false) ? 27110 : 17110;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "WALLCOIN server stopping";
}
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use wallcoind";
